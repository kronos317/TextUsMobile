...
//        
//        JSQMessagesAvatarImage *cookImage = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"clip.png"]
//                                                                                       diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
//        
//        JSQMessagesAvatarImage *jobsImage = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"clip.png"]
//                                                                                       diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
//        
//        JSQMessagesAvatarImage *wozImage = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"clip.png"]
//                                                                                      diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
//        
...
{
    JSQPhotoMediaItem *photoItem = [[JSQPhotoMediaItem alloc] initWithImage:[UIImage imageNamed:@"clip.png"]];
